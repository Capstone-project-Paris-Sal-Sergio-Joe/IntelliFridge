...
('Lean Fish', 3, 240, 4),
('Beans', 10, 30, 2),
('Canned Ham', 270, 360, 4),
('Cooked Ham',7,60, 4),
('Lamb',2,120,4),
('Ground Pork',2,120,4),
('Pork Chops',5,180,4),
('Meat Leftovers',4,90,4),
('Gravy',2,120,4),
('Fried Chicken',4,120,4),
('Fatty Fish',2,90,4),
('Cooked Fish',4,120,4),
('Smoked Fish',14,60,4),
...
('Avocado',10,300,2),
('Bananas',9,90,2),
('Canned Fruit',360,720,2),
('Cherries',10,240,2),
('Dried Fruit',360,720,2),
('Cranberry Sauce',10,31,2),
('Figs',7,240,2),
('Grapefruit',35,240,2),
('Kiwi',21,310,2),
('Lemon/Limes',50,240,2),
('Mangoes',14,240,2),
('Olives',360,360,2),
('Oranges',60,240,2),
('Peaches',5,180,2),
('Tomatoes',14,240,2),
('Frozen Vegetables',240,300,2),
('Pasta',7,240,1),
('Noodles',7,240,1),
('Hard Cheese',90,210,3),
('Cottage Cheese',10,90,3),
('Soft Cheese',14,180,3),
('Cream Cheese',28,60,3),
('Tofu',5,150,4),
('Barbecue Sauce',240,360,4),
('Cake',4,120,5),
('Chocolate',180,240,5),
('Cookie Dough',5,180,5),
('Cookies',21,180,5);
