package com.example.intellifridge;

import com.example.intellifridge.services.UserDetailsLoader;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(
                        ...
                        "/fridge/{id}",
                        "/fridge/{id}/add-food",
                        "/fridge/{fridgeId}/food/{foodId}/delete",
                        "/fridge/{id}/delete",
                        "/profile/add-user-to-fridge/{id}",
                        "/profile/{id}/edit",
                        "/profile/{id}/editImage"
